...
[assembly: WebActivatorEx.PostApplicationStartMethod(typeof(Medlebox.App_Start.BootstrapBundleConfig), "RegisterBundles")]

namespace Medlebox.App_Start
{
	public class BootstrapBundleConfig
	{
		public static void RegisterBundles()
		{
            ...
            BundleTable.Bundles.Add(new ScriptBundle("~/bundles/typeahead").Include("~/Scripts/bootstrap-typeahead.js"));
